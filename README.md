my_cpp_program Omnibus project
==============================
...
```shell
$ bin/omnibus build my_cpp_program
```
...
```shell
$ bin/omnibus clean my_cpp_program
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/my_cpp_program`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean my_cpp_program --purge
```
...
[vagrant@ubuntu...] $ cd my_cpp_program   # or 'cd my_cpp_program/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build my_cpp_program
```
